  ...
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-poppins items-center justify-start mx-auto w-full">
        <div className="h-[804px] md:px-5 relative w-full">
          <div className="absolute h-[804px] inset-[0] justify-center m-auto w-full">
            <Img
              ...
              alt="rectangle1938"
            />
            <div className="absolute bottom-[19%] flex flex-col items-center justify-start left-[4%] w-[84%]">
              <div className="flex flex-col gap-[17px] items-start justify-start w-full">
                ...
                <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between w-full">
                  <div className="flex h-[408px] md:h-[70px] relative w-[70%] md:w-full">
                    <Text
                      className="absolute bottom-[6%] leading-[29.00px] right-auto text-white-A700 text-xl top-[47%] tracking-[0.50px] w-4/5 sm:w-full"
                      size="txtPoppinsRegular16"
                    >
                      Kami bangga menyambut Anda di FitLife Gym, tempat di mana
                      perjalanan menuju hidup yang lebih sehat dan bugar
                      dimulai.
                    </Text>
                    <Button
                      className="common-pointer absolute bottom-[0] cursor-pointer font-semibold left-[6%] min-w-[200px] rounded-[10px] text-center text-lg tracking-[1.00px]"
                  ...
                  <div className="flex md:flex-1 flex-col gap-5 items-center justify-start w-[14%] md:w-full">
                    ...
                    <div className="bg-white-A700_63 flex flex-col items-start justify-start p-[9px] rounded-[20px] w-full">
                      <Text
                        className="block items-start justify-end ml-5 md:ml-[0] sm:text-4xl md:text-[38px] text-[40px] text-red-A400 tracking-[1.00px]"
          ...
          <header className="absolute flex flex-col inset-x-[0] items-center justify-center mx-auto top-[0] w-full">
            <div className="bg-lime-800 flex flex-1 flex-row items-center justify-start p-4 w-full">
              <Img
              ...
              <div className="flex flex-row font-roboto gap-[5px] items-center justify-center ml-[27px] w-[11%]">
                <Img
            ...
            <div
              className="bg-cover bg-no-repeat flex flex-1 flex-col h-[81px] items-center justify-start p-[21px] sm:px-5 w-full"
            ...
            >
              <div className="flex md:flex-col flex-row md:gap-5 items-center justify-start w-[92%] md:w-full">
                ...
                <Text
                  className="md:ml-[0] ml-[568px] text-black-900 text-sm tracking-[1.50px]"
                ...
                <Text
                  className="md:ml-[0] ml-[51px] text-black-900 text-sm tracking-[1.50px]"
                  size="txtPoppinsMedium14"
                >
                  ARTIKEL
                </Text>
                ...
                <Text
                  className="common-pointer md:ml-[0] ml-[101px] text-black-900 text-sm tracking-[1.50px]"
                  size="txtPoppinsMedium14"
                  onClick={() => navigate("/daftar")}
                >
                  DAFTAR
                ...
                <Button
                  className="common-pointer cursor-pointer min-w-[94px] md:ml-[0] ml-[37px] rounded-[3px] text-center text-sm tracking-[1.50px]"
        ...
        <div className="flex flex-col items-center justify-start max-w-[1296px] mt-[135px] mx-auto md:px-5 w-full">
          <div className="flex flex-col gap-[42px] items-center justify-start w-full">
            <div className="flex sm:flex-col flex-row md:gap-10 items-start justify-between w-[99%] md:w-full">
              ...
              <Text
                className="sm:mt-0 mt-[26px] text-black-900_97 text-xs tracking-[1.50px]"
            ...
            <div className="md:gap-5 gap-[43px] grid sm:grid-cols-1 md:grid-cols-2 grid-cols-3 justify-center min-h-[auto] w-full">
              <div className="flex flex-1 flex-col justify-start w-full">
                <div className="md:h-[250px] h-[280px] relative w-full">
                  ...
                  <div className="absolute bottom-[9%] md:h-[30px] h-[34px] right-[0] w-1/5">
                    ...
                    />
                    <Text
                      className="absolute bottom-[0] right-[6%] text-black-900 text-xl tracking-[1.37px]"
                      size="txtPoppinsSemiBold20"
                    >
                      58:24
                    </Text>
              ...
              <div className="flex flex-1 flex-col justify-start w-full">
                <div className="md:h-[250px] h-[283px] relative w-full">
                  <Img
                    className="absolute h-[250px] inset-x-[0] mx-auto rounded-[50%] top-[0] w-full"
            ...
            <div className="flex flex-col justify-start w-full">
              <div className="flex flex-col relative w-full">
                <div className="h-[733px] mx-auto w-full">
                  <div className="absolute bg-black-900_63 flex flex-col gap-[25px] h-full inset-y-[0] items-start justify-center my-auto p-[120px] md:px-10 sm:px-5 right-[0] w-[74%]">
                    <Text
                    ...
                    <Button
                      className="cursor-pointer font-semibold mb-[163px] min-w-[200px] md:ml-[0] ml-[201px] rounded-[10px] text-center text-lg tracking-[1.00px]"
                      color="gray_900"
                      size="xl"
                      variant="fill"
                    >
        ...
        <div className="flex flex-col items-center justify-start max-w-[1307px] mt-[147px] mx-auto md:px-5 w-full">
          <div className="flex flex-col items-center justify-start w-full">
            <div className="flex flex-col justify-start w-full">
              <Text
                className="md:ml-[0] ml-[615px] sm:text-[35.04px] md:text-[41.04px] text-[45.04px] text-black-900"
                size="txtPoppinsMedium4504"
              >
                Artikel
              </Text>
              <Text
                className="md:ml-[0] ml-[265px] mt-3 sm:text-[16.27px] md:text-[18.27px] text-[20.27px] text-gray-700"
              ...
              <List
                className="sm:flex-col flex-row font-dmsans gap-[33px] grid sm:grid-cols-1 md:grid-cols-2 grid-cols-3 justify-center mt-[50px] w-full"
              ...
              <Button
                className="block border-r-black-900 border-solid cursor-pointer font-bold font-dmsans justify-center leading-[normal] min-w-[253px] md:ml-[0] ml-[52px] mt-[52px] rounded-[39px] sm:text-[16.27px] md:text-[18.27px] text-[20.27px] text-center"
                color="gray_900"
                size="2xl"
                variant="outline"
              >
